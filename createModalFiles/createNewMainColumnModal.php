<?php
echo "<button class='btn btn-info btn-sm btn-circle' data-toggle='modal' data-target='#newMainColumnModal' data-group='".$row['groupname']."' data-category1='".$row['category1']."' id='createNewMainColumn'>Create New Row</button>";
